...
function Service() {
    const items = [
        ...
        },
        {
          ...
          image: "https://images.unsplash.com/photo-1529634897751-1f1d9e0c7f9c",
        },
        {
          id: 3,
          label: "Wedding",
        ...
        },
        {
          ...
          sub: "Couple Portrait",
          tag: "Romantic Frames",
          desc: "Elegant portraits capturing the magic between two hearts.",
    ...
    return (
        <div className="bg-[#faf8f4] " style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          ...
          <div className="flex items-end justify-between flex-wrap gap-6">
            ...
            <div>
              ...
              <div className="svc-heading-reveal">
                <h1
                  ...
                  style={{ fontSize: "clamp(64px, 10vw, 128px)", letterSpacing: "-0.03em" }}
                >
                  <span>Our </span>
            ...
            <div className="max-w-xs mb-2">
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 300 }}
              >
                Scroll to explore our full range of photography services — each crafted with intention and artistry.
              </p>
            </div>
          </div>
            ...
            <div ref={containerRef} className="scroll-container">
                ...
                >
                  ...
                  <div className="item-content">
                    ...
                    >
                      {item.label}
                      <span className="italic text-white/60 ml-2">{item.sub}</span>
                    </h2>
